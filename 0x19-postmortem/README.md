...
- 05-02-2022 10:20 AM GMT+1: Winus, one of our backend engineers, encountered the same issue when attempting to log in.
...
- 05-02-2022 10:50 AM GMT+1: Winus hypothesized that the password wasn't being hashed correctly.
...
- The issue stemmed from the outdated version of the bcrypt gem, which failed to handle password hashes properly. The version we had installed was incompatible with the hashing mechanism in our app. Winus corrected this by updating the Gemfile.lock to include a newer version of bcrypt, and once the necessary gems were reinstalled, the site functioned correctly.
